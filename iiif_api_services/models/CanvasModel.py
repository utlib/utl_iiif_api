...
class Canvas(Document):
    ...
    order = fields.IntField(
        default=0, 
        help_text=("The order in which this (sub)Canvas was given when created from a main Sequence.")
    )
    embeddedEntirely = fields.BooleanField(
        default=False, 
        help_text=("Whether this Canvas should embedded in its entirety in the response.")
    )
    ...
    height = fields.IntField(
        null=True, 
        help_text=("The height of a canvas or image resource. For images, the value is in pixels. For canvases, the value does not have a unit.")
    )
    width = fields.IntField(
        null=True, 
        help_text=("The width of a canvas or image resource. For images, the value is in pixels. For canvases, the value does not have a unit.")
    )
