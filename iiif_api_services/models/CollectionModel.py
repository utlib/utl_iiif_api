...
class Collection(Document):
    ...
    order = fields.IntField(
        default=0, 
        help_text=("The order in which this (sub)Collection was given when created from a main Collection.")
    )
    embeddedEntirely = fields.BooleanField(
        default=False, 
        help_text=("Whether this Collection should embedded in its entirety in the response.")
    )
